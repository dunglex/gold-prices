...
echo "Downloading https://btmc.vn/"
curl --connect-timeout 5 -k -v 'https://btmc.vn/' \
  ...
  -H 'user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36' > prices_btmc.html
